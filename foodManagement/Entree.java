...
public class Entree implements Listable {
	...
	// (above instance variable) This list will contain Food objects
	...
	public Entree(String nameIn, SortedListOfImmutables foodListIn) {
		name= nameIn;
		foodList= new SortedListOfImmutables(foodListIn); //shallow copy
	}

	/**
	 * Simple getter for name of Entree
	 * 
	...
	/**
	 *  Simple getter for FoodList for this entree.
	 *  
	 *  @return reference to a copy of the FoodList for this entree
	 */
	public SortedListOfImmutables getFoodList() {//a has an array inside
		return new SortedListOfImmutables(foodList);
	}

	/**
	 * Getter that returns the wholesale cost of the food in this entree
	 * 
	...
	/**
	 * Simple getter that returns the retail value of the food in this entree
	 * 
	...
	/**
	 * "incorrect" equals method that compares the current object to the 
	 * parameter and returns true if they have the same name.
	 * 
